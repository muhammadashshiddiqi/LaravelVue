              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" method="POST" action="{{ route('login') }}">
                    ...
                    <hr>
                    <button type="submit" class="btn btn-google btn-user btn-block"> <i class="fab fa-google fa-fw"></i> Login with Google </button>
                    <button type="submit" class="btn btn-facebook btn-user btn-block"> <i class="fab fa-facebook fa-fw"></i> Login with Facebook </button>
                  </form>
                  <hr>
                  <div class="text-center">
